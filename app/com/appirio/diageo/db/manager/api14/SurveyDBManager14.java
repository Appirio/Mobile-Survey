...
public class SurveyDBManager14 extends SurveyDBManager13 {
	...
	public ArrayNode getUniversalSurveys() throws DiageoServicesException {
		ArrayNode surveys = queryToJson("select name, sfid, survey_type__c, first_question__c from dms_survey__c order by sfid");
	...
	public ArrayNode getSurveys(ObjectNode account) throws DiageoServicesException {
		...
		ArrayNode surveys = queryToJson("select " +
											"name, sfid, survey_type__c, first_question__c " +
										"from " +
											"dms_survey__c " +
										"where " +
											"universal_survey__c " +
