...
public class SurveyDBManager13 extends SurveyDBManager12 {
	...
	public ArrayNode getUniversalSurveys() throws DiageoServicesException {
		ArrayNode surveys = queryToJson(getSQLStatement("survey-query-13"));
		ArrayNode questions = queryToJson(getSQLStatement("question-query-13"));
	...
	public ArrayNode getSurveys(ObjectNode account) throws DiageoServicesException {
		...
		String surveyQuery = MessageFormat.format(getSQLStatement("survey-query-with-filter-13"),account.get("tdlinx_sector__c").asText(),account.get("tdlinx_trade_channel__c").asText(),account.get("tdlinx_sub_channel__c").asText(),
