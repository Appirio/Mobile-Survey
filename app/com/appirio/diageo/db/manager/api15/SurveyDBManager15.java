...
public class SurveyDBManager15 extends SurveyDBManager14 {
	...
	public ArrayNode getUniversalSurveys() throws DiageoServicesException {
		ArrayNode surveys = queryToJson("select enable_edit_on_review_screen__c, name, sfid, survey_type__c, first_question__c, grading_scale__c, total_possible_score__c from dms_survey__c order by sfid");
	...
	public ArrayNode getSurveys(ObjectNode account) throws DiageoServicesException {
		...
		ArrayNode surveys = queryToJson("select " +
											"enable_edit_on_review_screen__c, name, sfid, survey_type__c, first_question__c, grading_scale__c, total_possible_score__c " +
										"from " +
											"dms_survey__c " +
										"where " +
											"universal_survey__c " +
